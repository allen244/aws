package com.avs.aws.bootstrap;


import com.avs.aws.domain.Author;
import com.avs.aws.domain.Product;
import com.avs.aws.domain.ProductCategory;
import com.avs.aws.repositories.AuthorRepository;
import com.avs.aws.repositories.ProductCategoryRepository;
...
public class DevOpsBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        target= AwsUtil.toList(authorRepository.findAll());
